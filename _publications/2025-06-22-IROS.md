...
<figure class="content-figure content-figure--narrow">
  <img
    src="../files/Surfel_figure1.jpeg"
    alt="Adaptive surfel mapping illustration"
    decoding="async"
  >
  <figcaption>
    <strong>Figure.</strong> Illustration of the novel view image synthesis of static 
...
backgrounds in the synthesized images.
  </figcaption>
</figure>
...
construction and adaptation. The removed backgrounds and other occluded regions within 3D scene geometric models 

...
<div class="document-viewer-shell">
  <div class="lazy-embed js-lazy-embed">
    ...
    <iframe class="document-embed document-embed--pdf lazy-embed__frame" data-src="../files/Graded Interlocks for Iontronic Pressure Sensors with High Sensitivity and High Linearity over a Broad Range.pdf" title="ACS Nano PDF preview" data-i18n-title-en="ACS Nano PDF preview" data-i18n-title-zh="ACS Nano 论文 PDF 预览" loading="lazy"></iframe>
  </div>
</div>

<div class="content-link-row">
  <a class="btn btn--inverse" href="../files/Graded Interlocks for Iontronic Pressure Sensors with High Sensitivity and High Linearity over a Broad Range.pdf" target="_blank" rel="noopener">{% include i18n-text.html en="Open PDF" zh="打开 PDF" %}</a>
